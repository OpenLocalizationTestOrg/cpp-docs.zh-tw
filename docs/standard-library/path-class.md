...
ms.openlocfilehash: 31afbf5ec6706ff58614ec8b97e5f4a0c158e57d
...
basic_string<Elem, Traits, Alloc> string(const Alloc& al = Alloc()) const; string string() const;
```  
