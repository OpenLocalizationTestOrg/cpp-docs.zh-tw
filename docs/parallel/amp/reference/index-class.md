...
ms.openlocfilehash: c3706dc1fcf037a59dae81ff7fec5b0c1c4572a5
...
```  
### Parameters
_Rhs The number to divide by to find the modulus.
Return Value The index object.
...
### Parameters
_Index An integer from 0 through the rank minus 1.
...
``` 
### Parameters
_Other The index object to copy from.
